...
return {
  ...
  -- All of these come directly from the main repository
  -- Removed some I definitely am not going to use, but not
  ...
  keys = {
    ...
    -- LSP
    -- These ones I definitely use. Very good for C++/Python
    {
      "gd",
